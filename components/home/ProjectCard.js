...
export default function ProjectCard({ title, subtext, href }) {
  ...
  const card = (
    <div className="flex flex-col md:h-32 p-4 bg-white cursor-pointer transform transition rounded-md border-2 border-gray-100 text-gray-600 hover:text-gray-800 hover:shadow-lg hover:scale-105 hover:z-10 space-y-2">
